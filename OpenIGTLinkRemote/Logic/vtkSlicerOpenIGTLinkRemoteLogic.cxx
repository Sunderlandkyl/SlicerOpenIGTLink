...
//----------------------------------------------------------------------------
vtkMRMLIGTLQueryNode* vtkSlicerOpenIGTLinkRemoteLogic::GetCommandQueryNode(igtlioCommandPointer command)
{
...
//----------------------------------------------------------------------------
//bool vtkSlicerOpenIGTLinkRemoteLogic::SendCommand(CommandPointer command, const char* connectorNodeId)
//{
  //if ( command == NULL )
  //{
  ...
  //  return false;
  //}
  //if (command->GetStatus()==igtlioCommandWaiting)
  //{
  ...
  //command->SetResponseContent(NULL); // sets status to FAIL
  //command->SetStatus(igtlioCommandWaiting);
...
void vtkSlicerOpenIGTLinkRemoteLogic::ProcessMRMLNodesEvents(vtkObject* caller, unsigned long event, void * callData)
{
  ...
  //  {
  //    command->SetStatus(igtlioCommandExpired);
  //  }
  //  else
  //  {
  ...
  //    else
  //    {
  //      command->SetStatus(igtlioCommandFail);
  //    }
  //  }
  //  command->InvokeEvent(igtlioCommandCompletedEvent, commandQueryNode);
